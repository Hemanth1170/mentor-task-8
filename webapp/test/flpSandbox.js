		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetappsproject8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetappsproject8-display": {
								"semanticObject": "commindsetappsproject8",
								"action": "display",
								"description": "A Fiori application with real time use case with all kind of loops in Js.",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.apps.project8",
									"url": sap.ui.require.toUrl("com/mindset/apps/project8")
								}
							}
						}
					}
